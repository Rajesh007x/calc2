"""This is the addition A and value B from the calculation class"""
#this is called a namespace organize the classes
#It looks like how the program is organized
